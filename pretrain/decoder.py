...
class LightDecoder(nn.Module):
    def __init__(self, up_sample_ratio, out_channels, width=768, sbn=True):   # todo: the decoder's width follows a simple halfing rule; you can change it to any other rule
        super().__init__()
        self.width = width
        ...
        self.proj = nn.Conv2d(channels[-1], out_channels, kernel_size=1, stride=1, bias=True)
