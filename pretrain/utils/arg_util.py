...
class Args(Tap):
    ...
    exp_dir: str = "pretrain_checkpoints/20230827161847" # will be created if not exists
    ...
    resume_from: str = 'pretrain_checkpoints/20230827161847/resnet50_withdecoder_1kpretrained_spark_style.pth'   # resume the experiment from some checkpoint.pth; load model weights, optimizer states, and last epoch
