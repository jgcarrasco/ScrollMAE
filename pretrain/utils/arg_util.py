...
class Args(Tap):
    ...
    exp_dir: str = "pretrain_checkpoints/20241108120732" # will be created if not exists
    data_path: int = 20241108120732 # 20230827161847 (tutorial) 20231210121321 (large segment) 20230519195952 (tau)
    init_weight: str = ''   # use some checkpoint as model weight initialization; ONLY load model weights
    resume_from: str = "pretrain_checkpoints/20241108120732/resnet_3d_50_withdecoder_1kpretrained_spark_style.pth" # resume the experiment from some checkpoint.pth; load model weights, optimizer states, and last epoch
    n_layers: int = 30
